...
namespace glm
{
    ...
    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::xx() const
    {
        return vec<2, T, Q>(x, x);
    }

    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::xy() const
    {
        return vec<2, T, Q>(x, y);
    }

    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::xz() const
    {
        return vec<2, T, Q>(x, z);
    }

    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::yx() const
    {
        return vec<2, T, Q>(y, x);
    }

    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::yy() const
    {
        return vec<2, T, Q>(y, y);
    }

    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::yz() const
    {
        return vec<2, T, Q>(y, z);
    }

    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::zx() const
    {
        return vec<2, T, Q>(z, x);
    }

    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::zy() const
    {
        return vec<2, T, Q>(z, y);
    }

    template <typename T, qualifier Q>
    GLM_FUNC_QUALIFIER GLM_CONSTEXPR vec<2, T, Q> vec<3, T, Q>::zz() const
    {
